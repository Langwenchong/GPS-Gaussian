    ...
    def infer_seqence(self, view_select, ratio=0.5):
        ...
        for idx in tqdm(range(total_frames)):
            ...
            with torch.no_grad():
                ...
                data,gaussian_clouds = pts2render(data, bg_color=self.cfg.dataset.bg_color,export=self.cfg.export_ply)
            ...
            if self.cfg.export_ply:
                PlyData([PlyElement.describe(gaussian_clouds[0], "vertex")]).write(gaussian_clouds_path+'/%s_gaussians.ply' % (data['name']))
